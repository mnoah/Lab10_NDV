...
namespace Lab10_NDV
{
    class Program
    {
...

        {
            ...
            Console.WriteLine("Welcome to the Movie List Application n/");
            ...
            do
            {
                ...
                for (int index = 0; index < MovieList.Count; index++)
                {
                    ...
                    if (MovieInput == "1")
                    {
                        categoryToSearch = "drama";

                    }
                    else if (MovieInput == "2")
                    {
                        categoryToSearch = "scifi";
                    }
                    else if (MovieInput == "3")
                    {
                        categoryToSearch = "animated";
                    }
                    else if (MovieInput == "4")
                    {
                        categoryToSearch = "musical";
                    }
                    else if (MovieInput == "5")
                    {
                        categoryToSearch = "horror";
                    }
                    else if (MovieInput == "6")
                    {
                        categoryToSearch = "comedy";
                    }
                    else
                    {
                    ...
                    if (categoryToSearch == movie.getCategory())
                    {
